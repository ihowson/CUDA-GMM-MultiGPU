...
# FIXME: on CUDA 6.5, this gives the following error:
#     nvcc error   : 'ptxas' died due to signal 11 (Invalid memory reference)
# It seems to be working on CUDA 6.0
...
$(shell echo "#include <omp.h>\nint main() { omp_get_num_threads(); return 0; }" > test.c ; $(NVCC) -Xcompiler -fopenmp test.c)
...
$(info >>> WARNING - generating restricted compute/sm versions for testing <<<)
SMS = 30
...
#LIBRARIES += -lcublas -lgomp
LIBRARIES += -lcublas -liomp5
...
# gaussian_kernel.o:gaussian_kernel.cu
	# $(EXEC) $(NVCC) $(INCLUDES) $(ALL_CCFLAGS) $(GENCODE_FLAGS) -o $@ -c $<
...
gmm: gaussian.o invert_matrix.o readData.o
# gmm: invert_matrix.o readData.o
...
clean:
	rm -f gmm gaussian.o invert_matrix.o readData.o
	rm -rf ../../bin/$(OS_ARCH)/$(OSLOWER)/$(TARGET)$(if $(abi),/$(abi))/gmm
